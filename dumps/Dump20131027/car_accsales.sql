...
--
-- Table structure for table `accsales`
--
...
--
-- Dumping data for table `accsales`
--

LOCK TABLES `accsales` WRITE;
/*!40000 ALTER TABLE `accsales` DISABLE KEYS */;
/*!40000 ALTER TABLE `accsales` ENABLE KEYS */;
UNLOCK TABLES;
